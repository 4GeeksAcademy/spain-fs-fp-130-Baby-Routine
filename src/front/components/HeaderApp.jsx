...
export const HeaderApp = ({ showBackButton = false, onBackClick }) => {
  ...
  return (
    <div className="d-flex align-items-center justify-content-between p-3" style={{ backgroundColor: "var(--color-primario)", minHeight: "80px", position: "relative" }}>
      ...
      <div style={dropdownStyle}>
        <button style={dropdownItemStyle} onClick={() => navigate("/rutinas", { state: { from: window.location.pathname } })}>
